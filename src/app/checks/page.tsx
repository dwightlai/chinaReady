  ...
  return (
    <main className="bg-[var(--surface)] py-16 sm:py-24">
      <Container>
        ...
        <section aria-labelledby="planning-tools"><h2 id="planning-tools" className="mt-10 text-2xl font-extrabold">One question? Start with a planning tool.</h2><p className="mt-3 text-[var(--muted)]">Go straight to the decision you need. No full readiness questionnaire required.</p><PlanningTools /></section>
        <ToolGrid />
