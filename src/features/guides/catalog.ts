...
export const guideCatalog: Guide[] = [
  ...
  { slug: "buy-sim-or-esim-for-china", title: "How to choose a SIM or eSIM for mainland China travel", description: "Pick a data plan that works on landing and keep an airport backup if the first option fails.", category: "Connectivity", lastReviewedAt: reviewed, applicableChecks: ["readiness"], sourceNotes: [simSource], faqs: simEsimFaqs, howTo: guideHowTos["buy-sim-or-esim-for-china"], Content: SimEsimGuide },
  { slug: "vpn-in-china-2026", title: "Do you need a VPN in China in 2026", description: "Prepare for limited foreign app access on mainland networks without making a VPN your only arrival plan.", category: "Connectivity", lastReviewedAt: reviewed, applicableChecks: ["readiness"], sourceNotes: [vpnSource], faqs: vpnChinaFaqs, howTo: guideHowTos["vpn-in-china-2026"], Content: VpnChinaGuide },
  ...
  { slug: "didi-without-chinese-number", title: "How to use DiDi without a Chinese phone number", description: "Set up ride-hailing before a late airport transfer and keep a taxi-desk backup if verification fails.", category: "Hotel arrival", lastReviewedAt: reviewed, applicableChecks: ["hotel-arrival", "readiness"], sourceNotes: [didiSource], faqs: didiFaqs, howTo: guideHowTos["didi-without-chinese-number"], Content: DidiGuide },
