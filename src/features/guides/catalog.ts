...
export const guideCatalog: Guide[] = [
  { slug: "test-mobile-payment-before-china", title: "How to Test WeChat Pay and Alipay Before Your China Trip", description: "Card linked does not mean payment tested. Learn what to check before departure, how to test at a China merchant, and what to do if payment fails.", category: "Payments", lastReviewedAt: reviewed, applicableChecks: ["payment", "readiness", "apps"], sourceNotes: [paymentSource], faqs: paymentTestFaqs, howTo: guideHowTos["test-mobile-payment-before-china"], Content: PaymentTestGuide },
  ...
  { slug: "confirm-late-hotel-check-in-china", title: "Late Hotel Check-in in China: Bilingual Request Template", description: "Arriving late or after midnight? Copy an English and Chinese message to ask your hotel to hold the room and confirm check-in arrangements.", category: "Hotel arrival", lastReviewedAt: reviewed, applicableChecks: ["hotel-arrival", "readiness"], sourceNotes: [hotelLateSource], faqs: lateCheckInFaqs, howTo: guideHowTos["confirm-late-hotel-check-in-china"], Content: LateCheckInGuide },
  { slug: "save-hotel-name-address-in-chinese", title: "Chinese Hotel Address Card for Taxi Drivers: Copy and Save", description: "Create a copyable hotel address card from your hotel’s official Chinese name, address and phone number. Save it offline for taxi drivers.", category: "Hotel arrival", lastReviewedAt: reviewed, applicableChecks: ["hotel-arrival", "readiness"], sourceNotes: [hotelAddressSource], faqs: chineseHotelAddressFaqs, howTo: guideHowTos["save-hotel-name-address-in-chinese"], Content: ChineseHotelAddressGuide },
