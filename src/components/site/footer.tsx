        ...
        <div className="flex flex-col justify-between gap-8 sm:flex-row sm:items-start">
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-[var(--muted)]">
              Reports are guidance, not official advice. Confirm payments, bookings and policies with the provider before travel.
            </p>
            <p className="mt-3 text-sm text-[var(--muted)]">Content last reviewed {formatReviewDate(siteConfig.lastReviewedAt)}</p>
